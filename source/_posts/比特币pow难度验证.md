...
根据比特币的源码，调整难度也是有限度的，如果调整的倍数超过4倍，按照4倍或者四分之一来调整。再次强调一遍，区块中的难度不是直接写入区块头的，是调整bits值得到的。有兴趣可以看[这里](https://github.com/bitcoin/bitcoin/blob/45173fa6fca9537abb0a0554f731d14b9f89c456/src/pow.cpp#L49)。
